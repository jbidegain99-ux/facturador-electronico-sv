...
describe('ClientesService', () => {
    ...
    describe('findAll', () => {
        it('should return paginated results with defaults', async () => {
            const clientes = [(0, test_fixtures_1.createMockCliente)(), (0, test_fixtures_1.createMockCliente)({ id: 'cliente-2' })];
    ...
    describe('create', () => {
        it('should create a cliente when numDocumento is unique', async () => {
            const newCliente = (0, test_fixtures_1.createMockCliente)();
            ...
            expect(prisma.cliente.create).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should throw ConflictException when numDocumento already exists', async () => {
            prisma.cliente.findUnique.mockResolvedValue((0, test_fixtures_1.createMockCliente)());
            const dto = {
                tipoDocumento: '36',
                numDocumento: '06141234567890',
                nombre: 'Duplicate',
            ...
            await expect(service.create('tenant-1', dto)).rejects.toThrow(common_1.ConflictException);
        });
    });
    describe('findOne', () => {
        it('should return cliente when found', async () => {
            const cliente = (0, test_fixtures_1.createMockCliente)();
        ...
        it('should throw NotFoundException when not found', async () => {
            ...
            await expect(service.findOne('tenant-1', 'nonexistent')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('remove', () => {
        ...
        it('should throw ConflictException when cliente has associated DTEs', async () => {
            ...
            await expect(service.remove('tenant-1', 'cliente-1')).rejects.toThrow(common_1.ConflictException);
        });
    });
});
