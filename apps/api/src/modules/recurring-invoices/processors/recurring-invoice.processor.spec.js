...
const recurring_invoice_processor_1 = require("./recurring-invoice.processor");
...
describe('RecurringInvoiceProcessor', () => {
    ...
    const templateWithRelations = {
        ...
        tenant: (0, test_fixtures_1.createMockTenant)(),
    };
    beforeEach(() => {
        ...
        processor = new recurring_invoice_processor_1.RecurringInvoiceProcessor(prisma, mockDteService, mockRecurringService);
    });
    ...
    it('should create DTE from template and record success', async () => {
        ...
        expect(mockDteService.createDte).toHaveBeenCalledWith('tenant-1', '01', expect.objectContaining({
    ...
    it('should record failure on exception', async () => {
        ...
        await expect(processor.process(createJob({ templateId: 'template-1' }))).rejects.toThrow('API error');
