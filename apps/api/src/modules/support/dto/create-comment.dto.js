...
let CreateCommentDto = (() => {
    ...
    return class CreateCommentDto {
        static {
            ...
            _content_decorators = [(0, swagger_1.ApiProperty)({ description: 'Contenido del comentario' }), (0, class_validator_1.IsString)()];
            _isInternal_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Es un comentario interno (solo visible para admins)', default: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)()];
        ...
        isInternal = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _isInternal_initializers, void 0));
        constructor() {
