...
let DireccionDto = (() => {
    ...
    return class DireccionDto {
        static {
            ...
            _complemento_decorators = [(0, swagger_1.ApiProperty)({ example: 'Colonia Escalon, Calle Principal #123' }), (0, class_validator_1.IsString)()];
...
let UpdateTenantDto = (() => {
    ...
    return class UpdateTenantDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _nombre_decorators = [(0, swagger_1.ApiProperty)({ example: 'Mi Empresa S.A. de C.V.', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            ...
            _actividadEcon_decorators = [(0, swagger_1.ApiProperty)({ example: '46510', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _direccion_decorators = [(0, swagger_1.ApiProperty)({ required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsObject)(), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(() => DireccionDto)];
            ...
            _correo_decorators = [(0, swagger_1.ApiProperty)({ example: 'empresa@ejemplo.com', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEmail)()];
