    ...
    if (success) {
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            <link_1.default href="/login" className="font-semibold text-primary hover:text-primary/80 transition-colors">
    ...
    return (<div className="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-background">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6" onSubmit={handleSubmit}>
          {error && (<div className="rounded-md p-4 border bg-destructive/10 border-destructive/20">
