    ...
    return (<div className="space-y-6">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-lg gradient-primary flex items-center justify-center">
              <lucide_react_1.Server className="w-5 h-5 text-white"/>
            </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-lg gradient-secondary flex items-center justify-center">
              <lucide_react_1.Database className="w-5 h-5 text-white"/>
            </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center">
              <lucide_react_1.Mail className="w-5 h-5 text-white"/>
            </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {/* Catalogos */}
          <link_1.default href="/admin/catalogos" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center">
                <lucide_react_1.BookOpen className="w-4 h-4 text-white"/>
              </div>
              <h3 className="font-medium text-white group-hover:text-purple-400 transition-colors">Gestion de Catalogos</h3>
              <lucide_react_1.ExternalLink className="w-4 h-4 text-muted-foreground ml-auto opacity-0 group-hover:opacity-100 transition-opacity"/>
            </div>
          ...
          {/* Planes */}
          <link_1.default href="/admin/planes" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center">
                <lucide_react_1.Gauge className="w-4 h-4 text-white"/>
              </div>
          ...
          {/* Notificaciones */}
          <link_1.default href="/admin/notificaciones" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-yellow-500 to-orange-600 flex items-center justify-center">
                <lucide_react_1.Bell className="w-4 h-4 text-white"/>
              </div>
          ...
          {/* Logs y Auditoria */}
          <link_1.default href="/admin/logs" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-500 to-gray-600 flex items-center justify-center">
                <lucide_react_1.FileText className="w-4 h-4 text-white"/>
              </div>
          ...
          {/* Backups */}
          <link_1.default href="/admin/backups" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center">
                <lucide_react_1.HardDrive className="w-4 h-4 text-white"/>
              </div>
          ...
          {/* Webhooks */}
          <link_1.default href="/admin/webhooks" className="glass-card p-5 hover:border-purple-500/50 transition-colors group">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center">
                <lucide_react_1.Webhook className="w-4 h-4 text-white"/>
              </div>
