    ...
    return (<div className="space-y-6">
      ...
      <div className="glass-card p-8 text-center">
        <div className="w-20 h-20 mx-auto rounded-full bg-primary/10 flex items-center justify-center mb-6">
          <lucide_react_1.Webhook className="w-10 h-10 text-primary"/>
        </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-green-500/10">
              <lucide_react_1.Lock className="w-5 h-5 text-green-400"/>
            </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-purple-500/10">
              <lucide_react_1.ExternalLink className="w-5 h-5 text-purple-400"/>
            </div>
      ...
      <div className="glass-card p-6">
        ...
        ].map((item) => (<div key={item.event} className="p-3 rounded-lg bg-white/5 flex items-center gap-3">
              <lucide_react_1.Send className="w-4 h-4 text-muted-foreground"/>
              <div>
      ...
      <div className="glass-card p-6">
        ...
        <div className="space-y-4">
          ...
          <button_1.Button variant="outline" disabled className="w-full">
            <lucide_react_1.Webhook className="w-4 h-4 mr-2"/>
            Configurar Webhook
          </button_1.Button>
        </div>
      </div>
