      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-0 border-b">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <link_1.default href="/login" className="btn-secondary text-sm px-4 py-2">
              Iniciar Sesion
            </link_1.default>
            <link_1.default href="/register" className="btn-primary text-sm px-4 py-2">
              Registrarse
            </link_1.default>
          </div>
        </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <link_1.default href="/register" className="btn-primary text-lg px-8 py-4 flex items-center gap-2">
              Comenzar Gratis
              <lucide_react_1.ArrowRight className="w-5 h-5"/>
            </link_1.default>
            <link_1.default href="/login" className="btn-secondary text-lg px-8 py-4">
              Ya tengo cuenta
            </link_1.default>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-8 card-hover">
              <div className="w-14 h-14 rounded-xl gradient-primary flex items-center justify-center mb-6">
                <lucide_react_1.FileText className="w-7 h-7 text-white"/>
              </div>
            ...
            <div className="glass-card p-8 card-hover">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center mb-6">
                <lucide_react_1.Building2 className="w-7 h-7 text-white"/>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass-card p-8">
              ...
              <link_1.default href="/register" className="btn-secondary w-full text-center block">
                Comenzar Gratis
              </link_1.default>
            </div>
            ...
            <div className="glass-card p-8 border-2 border-primary relative">
              ...
              <link_1.default href="/register" className="btn-primary w-full text-center block">
                Comenzar Ahora
              </link_1.default>
            </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="glass-card p-12 glow-primary">
            ...
            <link_1.default href="/register" className="btn-primary text-lg px-8 py-4 inline-flex items-center gap-2">
              Crear Cuenta Gratis
              <lucide_react_1.ArrowRight className="w-5 h-5"/>
            </link_1.default>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              <link_1.default href="#" className="hover:text-white transition-colors">Terminos</link_1.default>
              <link_1.default href="#" className="hover:text-white transition-colors">Privacidad</link_1.default>
              <link_1.default href="#" className="hover:text-white transition-colors">Soporte</link_1.default>
            </div>
